...
class Hotel:
    def __init__(self) -> None:
        self.rooms = load_from_json(model_class=Room, file_path=create_path_to_data("rooms.json"))
        self.bookings = load_from_json(model_class=Booking, file_path=create_path_to_data("bookings.json"))
